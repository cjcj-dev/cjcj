...
> **Repository notice:** the former standalone `cangjie-build` repository is
> deprecated. This project is maintained as part of `cjcj` under
> `cangjie-build/`; use this in-tree copy as the source of truth.
