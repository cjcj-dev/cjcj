...
: "${CJCJ_BOOTSTRAP_COLOUR_LLVM_SO:?}"
: "${CJCJ_BOOTSTRAP_COLOUR_LLVM_SHA256:?}"
...
exec bash "$root/ci/bootstrap/bootstrap.sh" \
  ...
  --colour-llvm-so "$CJCJ_BOOTSTRAP_COLOUR_LLVM_SO" \
  --colour-llvm-sha256 "$CJCJ_BOOTSTRAP_COLOUR_LLVM_SHA256" \
