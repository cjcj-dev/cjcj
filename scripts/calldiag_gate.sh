#!/usr/bin/env bash
# calldiag_gate.sh — call-diagnostic (DiagOld re-enable band-1) gate for the selfhost compiler.
#
...
FIXROOT="$HERE/calldiag_fixtures"
...
echo ""; echo "===== calldiag_gate summary ($LABEL) ====="
echo "compiler: $CJC"
