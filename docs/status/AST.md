...
- Extended the AST-local Basic/Lex compatibility layer with `Linkage` equality plus the `mut`, pipeline, and composition tokens needed by mirror-property conversion and desugar recovery.
