...
## 二、当前基线（2026-07-08，master @ 81e9be0c）

| 维度 | 数值 |
|---|---|
| 库包自编译（A1） | ✅ 18/18（+ cjc 驱动链接 = stage2 二进制 63MB） |
| difftest / smoke15 | 114/114 / 15/15 |
| bcgate | byte-identical **2372/2490（95.3%）**，differing **118**，fully-identical 43/114，compile-errors 0 |
...
- [x] bcgate ≥95%（2372/2490，2026-07-08）
- [ ] 宏自举 5/5（Phase 2）
